...
class Block():
	...
	def GetLineStartRotation(self):
		return (self.Convert(self._sry), self.Convert(self._srz), self.Convert(self._srx))

	def GetLineEndRotation(self):
		return (self.Convert(self._ery), self.Convert(self._erz), self.Convert(self._erx))
