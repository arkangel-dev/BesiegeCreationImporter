...
class Reader():
	...
	def ReadBlockData(self) -> List[Block]:
		try:
			...
			return {'RETURN_LIST' : returnList, 'TOTAL_BLOCKS' : total_blocks, 'TOTAL_COMPONENTS' : total_components, 'SKIPPED_BLOCKS' : skipped_blocks, 'FAILED' : False}
		except:
			return {'RETURN_LIST' : 0, 'TOTAL_BLOCKS' : 0, 'TOTAL_COMPONENTS' : 0, 'SKIPPED_BLOCKS' : 0, 'FAILED' : True}
